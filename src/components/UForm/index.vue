    ...
    <el-form  
      ...
      <el-form-item v-for="item in options" :label="item.label" :prop="item.prop">
        ...
        <template v-if="item.type === 'input'">
          <el-input v-bind="item.attrs" :placeholder="item.placeholder" v-model="model[item.prop!]"></el-input>
        </template>
        <template v-if="item.type === 'input-number'">
          <el-input-number v-bind="item.attrs" :placeholder="item.placeholder" v-model="model[item.prop!]"></el-input-number>
        </template>
        ...
        <template v-if="item.type === 'select'">
          <el-select v-bind="item.attrs" :placeholder="item.placeholder" v-model="model[item.prop!]">
            <el-option v-for="op in item.options" :key="op.value" :value="op.value" :label="op.key"></el-option>
          </el-select>
        </template>
        <template v-if="item.type === 'radio-group'">
          <el-radio-group v-model="model[item.prop!]" v-bind="item.attrs">
            <el-radio v-for="op in item.options" :label="op.value">{{op.key}}</el-radio>
          </el-radio-group>
        </template>
